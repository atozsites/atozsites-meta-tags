    ...
    __( 'General tags', 'dp-meta-tags' ) => [
        ...
        'fields' => [
            'description' => [
                ...
                'variable' => 'ATOZSITES_general_description'
            ],
            ...
            'keywords' => [
                ...
                'variable' => 'ATOZSITES_general_keywords'
            ]
        ]
    ],
    ...
    __( 'Open Graph', 'dp-meta-tags' ) => [
        ...
        'fields' => [
            'og:title' => [
                ...
                'variable' => 'ATOZSITES_og_title'
            ],
            'og:description' => [
                'info' => __( 'A short summary about the content.', 'dp-meta-tags' ),                
                'variable' => 'ATOZSITES_og_description'
            ],
            'og:type' => [
                ...
                'variable' => 'ATOZSITES_og_type'
            ],
            'og:audio' => [
                'info' => __( 'URL to your content\'s audio.', 'dp-meta-tags' ),                 
                'variable' => 'ATOZSITES_og_audio'
            ],
            'og:image' => [
    ...
    __( 'Twitter Cards', 'dp-meta-tags' ) => [
        ...
        'fields' => [
            ...
            'twitter:image' => [
                ...
                'variable' => 'ATOZSITES_twitter_image'
            ],
            'twitter:image:alt' => [
                'info' => __( 'A text description of the image for visually impaired users.', 'dp-meta-tags' ),
                'variable' => 'ATOZSITES_twitter_image_alt'
            ],
            'twitter:player' => [
