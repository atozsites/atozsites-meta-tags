        ...
        <table class="widefat striped">
            <thead>
                <tr>
                    ...
                    // meta tag groups
                    foreach ($ATOZSITES_meta_tag_list as $item => $details){
                        echo '<th>'. $item .' 
            ...
            <?php
                ...
                $items = ATOZSITES_Retrieve_List::get_list( $type, $items_per_page, $offset );
                
                $taginfo = new ATOZSITES_Retrieve_Tags( $ATOZSITES_meta_tag_list );
                    ...
                    foreach ( $items['list'] as $item ){
                        ...
                        <tr>
                            ...
                            foreach ($statuses as $group => $status){
                                ...
                                $var = $ATOZSITES_meta_tag_list[$group]['var'];
            ...
            <tfoot>
                ...
                // always autopilot buttons
                    ...
                    foreach ($ATOZSITES_meta_tag_list as $group => $info){
                        ...
                        if ( $group != 'Custom' ){
                            ...
                            if ( 
                                !empty($ATOZSITES_autopilot_settings) &&
